...
import { getMemberProfiles } from "@/features/aura/queries";
    ...
    <main className="ap-shell">
      ...
      <div className="ap-container py-14 sm:py-20">
        <section className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
          <div>
            <h1 className="text-5xl font-semibold leading-none sm:text-7xl">AURA</h1>
            ...
            <div className="ap-track">
              {members.map((profile) => (
                <Link
                  ...
                  key={profile.user.id}
                >
                  <AuraCard compact profile={profile} />
                </Link>
              ))}
            </div>
          </section>
